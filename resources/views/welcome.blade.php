...
<html lang="en">
  ...
  <a href="#" class="list-group-item list-group-item-action" aria-disabled="true" >vCARD Register</a>
  <a href="#" class="list-group-item list-group-item-action" aria-disabled="true" >vCARD Edit</a>
</div>
